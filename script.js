...
const I18N = {
  fr: {
    ...
    menu_start: "Jouer !",
    menu_settings: "VerbBreaker - Réglages",
    ...
    controls_hint: "",
    leaderboard_title: "VerbBreaker - Hall of Fame",
    ...
    menu_shop: "Boutique",
    shop_title: "VerbBreaker - Boutique de thèmes",
    shop_current: "Actif",
    shop_select: "Choisir",
    shop_buy: "Acheter",
  ...
  en: {
    ...
    menu_start: "Play!",
    menu_settings: "VerbBreaker - Settings",
    menu_leaderboard: "Hall of Fame",
    menu_back: "Back",
    ...
    super_points: "SUPER BONUS",
    menu_shop: "Shop",
    shop_title: "VerbBreaker - Theme Shop",
    shop_current: "Active",
    shop_select: "Select",
    shop_buy: "Buy",
...
function getActiveThemePatterns() {
  return THEME_PATTERNS[activeThemeId] || THEME_PATTERNS.modern_english;
}
...
function buildPatternOrder() {
  const patterns = getActiveThemePatterns();
  return shuffleArray([...Array(patterns.length).keys()]);
}
